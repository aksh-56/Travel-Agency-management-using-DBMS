...
<tr><td class="headingText">TOURS</td></tr>
...
<!--<tr><td class="image"><img src="Admin/subcatimages/<?php// echo $data[3]; ?>" width="250px" height="200px" /></td></tr><br/><br/>-->
    <tr><td class="image"><img src="images/<?php echo $data[2]; ?>" width="250px" height="200px" /></td></tr><br/><br/>
<tr><td align="center" style="background-color:#60B0E6; ">,<!--<a href="package.php?subcatid=<?php// echo $data[0];?>">--><a href="detail.php?pid=<?php echo $data[0];   ?>"><font color="#FFFFFF">View Detail</font></a></td></tr>
