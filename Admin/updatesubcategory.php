...
if (empty($_FILES['t2']['name'])) {
    ...
    $s="update subcategory set Subcatname='" . $_POST["t1"] ."',Pic='" . $_POST["h1"] . "',Detail='" . $_POST["t4"] . "' where Subcatid='" . $_POST["s1"] . "'";
...
else
{
		 ...
		 /*$s="update subcategory set Subcatname='" . $_POST["t1"] ."',Catid='" . $_POST["t2"] . "',Pic='" .  basename($_FILES["t3"]["name"]) . "',Detail='" . $_POST["t4"] . "' where Subcatid='" . $_POST["s1"] . "'";}*/
            ...
            $s="update subcategory set Subcatname='" . $_POST["t1"] ."',Pic='" .  basename($_FILES["t2"]["name"]) . "',Detail='" . $_POST["t4"] . "' where Subcatid='" . $_POST["s1"] . "'";}
...
<tr><td class="lefttxt">Select Tour</td><td><select name="s1" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Tour Name</td><td><input type="text" value="<?php if(isset($_POST["show"])){ echo $Subcatname ;} ?> " name="t1" required pattern="[a-zA-z1 _]{1,50}" title="Please Enter Only Characters and numbers between 1 to 50 for Subcategory Name" /></td></tr>
...
<tr><td class="lefttxt">Old Pic</td><td><img src="images/<?php echo @$Pic; ?>" width="150px" height="100px" / >
