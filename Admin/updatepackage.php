...
if(isset($_POST["sbmt"]))
{
	...
	if (empty($_FILES['t3']['name'])) {
        ...
        $s="update package set Packname='" . $_POST["t1"] ."',Subcategory='" . $_POST["t3"] . "',Packprice='" . $_POST["t8"] . "',Pic1='" . $_POST["h1"] . "',Pic2='" . $_POST["h2"]. "',Pic3='" .$_POST["h3"] . "',Detail='" . $_POST["t7"] . "' where Packid='" . $_POST["s1"] . "'";
...
else
{
    ...
    $s="update package set Packname='" . $_POST["t1"] ."',Subcategory='" . $_POST["t3"] . "',Packprice='" . $_POST["t8"] . "',Pic1='" .  basename($_FILES["t4"]["name"]) . "',Pic2='" .  basename($_FILES["t5"]["name"]) . "',Pic3='" .  basename($_FILES["t6"]["name"]) . "',Detail='" . $_POST["t7"] . "' where Packid='" . $_POST["s1"] . "'";}
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
<tr><td class="lefttxt">Select Tour</td><td><select name="t3" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Old Pic</td><td><img src="images/<?php echo @$Pic1; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Old Pic</td><td><img src="images/<?php echo @$Pic2; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Old Pic</td><td><img src="images/<?php echo @$Pic3; ?>" width="150px" height="50px" />
