...
<tr><td class="lefttxt">Select subcategory</td><td><select name="t2" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Select Package</td><td><select name="t3" required/><option value="">Select</option>
...
if(isset($_POST["sbmt"]))
{
	...
	*/
	...
	/*$s="insert into package(packname,category,subcategory,packprice,pic1,pic2,pic3,detail) values('" . $_POST["t1"] ."','" . $_POST["t2"] . "','" . $_POST["t3"] ."','". $_POST["t8"] . "','" . basename($_FILES["t4"]["name"]) . "','" . basename($_FILES["t5"]["name"]) . "','" . basename($_FILES["t6"]["name"]) . "','" . $_POST["t7"] ."')";*/
            $s="insert into package(packname,subcategory,packprice,pic1,pic2,pic3,detail) values('" . $_POST["t1"] ."','" . $_POST["t2"] ."','". $_POST["t8"] . "','" . basename($_FILES["t4"]["name"]) . "','" . basename($_FILES["t5"]["name"]) . "','" . basename($_FILES["t6"]["name"]) . "','" . $_POST["t7"] ."')";
	mysqli_query($cn,$s);
	mysqli_close($cn);
