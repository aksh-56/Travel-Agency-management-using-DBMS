...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style=' padding:5px;'><a href='subcat.php?subcatid=$data[0]'>$data[1]</a></td></tr>";
...
//$s="select * from package,category,subcategory where package.category=category.cat_id and package.subcategory=subcategory.subcatid and package.packid='" . $_GET["pid"] ."'";
    $s="select * from package,subcategory where package.subcategory=subcategory.subcatid and package.packid='" . $_GET["pid"] ."'";
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r; 
$n=0;
...
<!--<tr><td class="middletext"><img src="images/<?php //echo $data[4];?>" width="200px" height="200px"  /></td>

<td class="middletext" style="padding-left:15px"><img src="images/<?php //echo $data[5];?>" width="200px" height="200px"  /></td>
...
<?php //echo $data[9];?>
 <!--<br/>-->
  <span class="middletext">Tour:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php echo $data[7];?>
    <br/> </td></tr>
    <tr><td  colspan="3" height="90px"><span class="middletext">Price:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php echo $data[3];?>
</td></tr>
<!--<tr><td colspan="3"><p><?php// echo $data[7];?></p></td></tr>-->
